...
public class appication1 {
    public static void main(String[] args) {
        ...
        * 그렇기 때문에 다른 패키지에 존재하는 클래스를 사용하는 경우에는 클래스명 앞에 패키지명을 명시해 줘야 한다. */
        ...
        System.out.println("30과 20중 작은 수는? : " + min);

        /*static 메소드의 경우 */
        int max = com.ohgiraffers.section01.method.calculator.maxNumberOf(30, 20);
        System.out.println("30과 20중 큰 수는? " + max);

        //(석현) 역시 static답게 풀네임으로 해줘야 함
    }
}
