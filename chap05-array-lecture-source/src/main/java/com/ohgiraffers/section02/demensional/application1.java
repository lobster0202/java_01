...
public class application1 {
    public static void main(String[] args) {
        /*
        * [ 다차원 배열 ]
        * 다차원 배열은 2차원 이상의 배열을 의미히며,
        * 배열의 인덱스마다 또 다른 배열의 주소를 보관하는 배열이다.
...
//        iarr3 = new int[][3];
        ...
        *  가변 배열 : 서로 길이가 다른 배열 여러 개를 하나로 묶어 관리하는 2차원 배열 */
        ...
        for (int i = 0; i < iarr3.length; i++) {
            ...
            // hashcode를 통하여 고유의 값이 서로 다른 것을 보고 각자의 열이 다르다는 것을 알 수 있음
        ...
        // 중첩 for문을 통해서 배열 하나에 있는 걸 다 꺼낼수도 있다.
