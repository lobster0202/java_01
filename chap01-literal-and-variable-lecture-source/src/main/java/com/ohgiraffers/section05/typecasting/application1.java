...
//        int result1 = num1 + num2;    // 자동으로 큰 쪽 자료형인 long 변경 후 계산하기 때문엥 int형 변수에 담을 수 없다.
        long result1 = num1 + num2;     // int + long은 서로 다른 자료형이라 데이터 손실이 발생하지 않는 int -> 변환을 자동 수행 후 연산한다.
        ...
        * */
        ...
        /* 논리형은 형변환 규칙에서 제외된다.
        * 어느 자료형이든 boolean을 형변환해서 다음 수 없다.*/
        boolean isTrue = true;
//        byte b = isTrue;
//        int i = isTrue;
//        char c = isTrue;
