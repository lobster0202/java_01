...
public class application2 {
    ...
    public static  void main(String[] args) {
        ...
        System.out.println(123 / 10);
        System.out.println(123 % 10);       // %이란 123을 10으로 나눈뒤 나머지 값을 의미

        /* 필기. 실수끼리의 연산도 수학에서 사용하는 사칙연산에 나머지를 구하는 연산(mod)을 사용할 수 있다.*/
        System.out.println("===========실수와 실수의 연산 =============");
        System.out.println(1.23 + 1.23);   // 소수는 실수!
        System.out.println(1.23 - 0.23);
        System.out.println(1.23 * 12.0);
        System.out.println(1.23 / 10.0);
        System.out.println(1.23 % 1.0);    //약간의 오차가 생긴다.

        /* 필기. 정수와 실수 연산의 결과는 항상 실수 나온다. */
        System.out.println("=========== 정수와 실수의 연산 =========");
        System.out.println(123 + 0.5);  // sout 치면 바로 할 수 있음
        ...
        System.out.println('a' + 'b'); // 아스키코드에 해당하는 숫자를 통하여 계산함
        ...
        System.out.println('a' + 1.0); // 문자를 정수로 받아서 실수 형태로 값이 나온다.
        ...
        System.out.println("hello" + "world"); //문자열과 문자열의 연산에서는 더하기 밖에 안되고 다른거는 불가능함!
...
//        System.out.println(true % 'a');
        ...
        System.out.println(true + "a"); // 논리와 문자열인 "a" 가 합쳐지면 이어붙이기가 된다.
//        System.out.println(true - "a");
//        System.out.println(true * "a");
//        System.out.println(true / "a");
//        System.out.println(true % "a");
