...
public class application1 {
    public static void main(String[] args) { // main 이라고 치면 메인 메소드가 나옴

        /* 필기. 변수의 사용 목적
        * 1. 값에 의미를 부여하기 위한 목적(의미 전달이 쉬워야 코드를 알기 쉬워지고, 협업 및 유지보수가 쉬워진다.)
...
//      한번 사용한 값을 재사용하기 위한 예제
        ...
        sum = sum + 10;
        System.out.println("sum에 0이 있었으니 10을 추가로 더하면?" + sum);

        sum = sum + 10;
        System.out.println("sum에 10이 있었으니 10을 추가로 더하면?" + sum);
        // 코드가 위에서 아래로 진행되면서 더하게 된다.
