...
public class appliaciton {
    public static void main(String[] args) {
        ...
        * 재사용성을 높일 수 있는 프로그래밍 방식이다. */
        ...
        gt2.setValue("새해 복 많이 받으세요~");                               //(석현) String형이 아니라 정수같은걸 쓰면 컴파일 에러남
