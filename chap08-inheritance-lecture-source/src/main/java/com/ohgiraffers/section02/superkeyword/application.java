...
public class application {
    public static void main(String[] args) {
         ...
         *
         * [super()]
         * 부모생성자를 호출하는 구문으로 인자와 매개변수의 타입, 개수, 순서가 일치하는 부모의 생성자를 호출한다.
        ...
        Product product2 = new Product("S-01234","삼성","갤럭시 Z폴드",2398000,new java.util.Date());
        System.out.println(product2.getInformation());

        Computer computer1 = new Computer();
        System.out.println(computer1.getInformation());                     //Computer 클래스에서 super로 안하고 this.으로 해버리면 StackOverflow라는 오류가 뜸
