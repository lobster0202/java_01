...
public class application {
    public static void main(String[] args) {
        ...
        * 클래스 또한 부모클래스와 자식클래스로 역할을 나누어서 부모가 가지는 메버를 자식이 물려받아
        ...
        * 자식클래스가 정의한 메소드대로 동작하도록 구현부 부분을 새롭게 다시 작성하는 기술이다.
        ...
        *   1-2. 공통적으로 사용하는 코드가 부모클래스에 존재하면
        *        수정사항 발생 시 부모클래스만 수정해도 전체적으로 적용된다.(유지보수성 증가)
        * 2. 클래스 간의 계층 관계가 형성되며 다형성의 문법적인 토대가 된다.
        *
        * [상속의 단점]
        * 1. 부모클래스의 기능을 추가 / 변경할 경우 자식클래스가 정상 동작하는지 예측이 힘들다.
        *    상속 구조가 복잡해 질수록 그 영향에 대한 예측이 힘들며
        *    이런 단점이 유지보수성이 증가한다는 장점과 반대로 유지보수에 악영향을 준다.
